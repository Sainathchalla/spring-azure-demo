package com.IPL.MajorProject.EntityPkg;
...
public class MatchEntity{
    ...
    private Long result_margin;
    private Long target_runs;
    ...
    public Long getResult_margin() {
        return result_margin;
    }

    public void setResult_margin(Long result_margin) {
        this.result_margin = result_margin;
    }

    public Long getTarget_runs() {
        return target_runs;
    }

    public void setTarget_runs(Long target_runs) {
